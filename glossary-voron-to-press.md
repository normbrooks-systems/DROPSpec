...
**T-slot extrusion (2020 / 4080).** Slotted aluminum framing rail, named by cross-section in millimeters — the Lego of machine frames. 2020 (20×20 mm) is the desktop-printer commodity and forms DROPSpec's general frame; the gantry carrying the head assembly is specced up to 4080 (40×80 mm), because nearly two kilos of printhead scanning at a meter per second is not a 2020 job. The happy accident: industrial TIJ head units already ship with 40-series T-slot mounting, so commercial print hardware bolts to a 4080 gantry natively — your world and this world standardized on the same slot.

**V-slot / wheels.** The budget linear-motion option in the desktop-printer world: plastic-tired wheels rolling in the extrusion's grooves. Cheap, quiet, adequate — for light loads. DROPSpec's scan axis is not one: two kilos reversing at speed rides a proper linear rail, and V-slot survives in this project only on lighter duties, if anywhere. Analog: bushings vs. bearings — and this machine needs the bearings.
...
**Printed parts.** Structural components of the machine, 3D-printed — either by you or by the community member selling them. DROPSpec uses printed parts for carriers, clamps, gaskets (in flexible TPU), bezels. The RepRap conceit, still alive: machines whose parts reproduce.
