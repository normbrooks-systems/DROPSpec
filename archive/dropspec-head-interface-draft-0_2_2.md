...
**Draft 0.2.2 — pre-release working draft**
...
| Datum A / B / C | TBD | [DROPSpec] — see §3.2 |
...
**Figure A-1a** — contact position layout — and **Table A-1b** — contact position dimensions — are to be generated from flatbed scans of reference cartridge hardware, and are not included in this revision. Position pitch, pad size, column spacing, and film extent are UNDEFINED until they are.

The position numbering above is complete and usable without them; §5.4 requisitions by index, not by coordinate.
...
- Figure A-1a (contact position layout) and Table A-1b (contact position dimensions), to be generated from flatbed scans of reference hardware (Appendix A)
...
*Draft 0.2.2. Geometry gospel; contents wild west. Comments, measurements, and dissent welcome via the project repository.*
